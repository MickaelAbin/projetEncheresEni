...
<body>
	...
	<form action="<%=request.getContextPath()%>/Accueil"  method="POST">
		...
		<div>
			<input class="search" type="search" placeholder="Le nom de l'article contient">
		</div>
		...
		<input class="rechercher" type="submit" name="connexion" value="Rechercher"/>
	</form>
	...
	<c:if test="${empty listeArticles }">listes articles vide</c:if>
		<c:forEach var="articleVente" items="${sessionScope.listeArticles }">
			<div class="Enchere" style= "border: 1px solid black; background-color: lightgray; width: 40%; margin:10px; align-self: center;" classe="article">
